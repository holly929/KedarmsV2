  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow flex flex-col items-center p-4 md:p-8 overflow-y-auto no-print">
         {isPreparing ? (
            <div className="w-full max-w-md mt-10"><Progress value={(progress / allLicenses.length) * 100} /><p className="mt-2 text-center">Preparing {progress} / {allLicenses.length}</p></div>
         ) : (
